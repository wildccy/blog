...
const SquarePost = styled(BasePost)`
...
const WidePost = styled(BasePost)`
...
const SquareCase = styled(BaseCase)`
  width: 100%;
  padding-top: 100%;
`;
...
const WideCase = styled(BaseCase)`
...
const CoverBoxM = styled(CoverBase)`
  &:hover {
    > span {
